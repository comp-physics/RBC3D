...
contains
  ...
  subroutine GetVelocity
    ...
    type(t_TargetList) :: t_TargetList
    ...
    Nx = NINT(Lb(1)/dx0)
    print *, "Lb(1): ", Lb(1), "dx0: ", dx0, "Nx: ", Nx
    Ny = NINT(Lb(2)/dx0)
    print *, "Lb(2): ", Lb(2), "dx0: ", dx0, "Ny: ", Ny
    Nz = NINT(Lb(3)/dx0)
    print *, "Lb(3): ", Lb(3), "dx0: ", dx0, "Nz: ", Nz
  ...
  subroutine InitSystem
    ...
    ! Wall periodic boundary conditions
    do iwall = 1, nwall
      wall => walls(iwall)
